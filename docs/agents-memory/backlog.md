...
- Incorporar mejoras visuales y consistencia de branding
- Afinar mensajes de error y páginas de estado
- Preparar scripts de despliegue y revisión final de Docker
