...
| Área | Estado | Detalle |
| --- | --- | --- |
| Entorno local | En progreso | Maven Wrapper operativo en el repositorio y validación local realizada con JDK 17 |
...
| Backend | En progreso | Proyecto Spring Boot inicializado, entidades JPA, repositorios, servicios y controladores MVC base para usuarios, rutinas y pagos |
| Frontend | En progreso | CRUD MVC de usuarios, rutinas y pagos implementados con formularios, listados y vistas de detalle |
