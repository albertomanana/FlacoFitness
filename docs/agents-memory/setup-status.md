...
| Backend | En progreso | Proyecto Spring Boot inicializado, entidades JPA, repositorios, servicios y controladores MVC base para usuarios y rutinas |
| Frontend | En progreso | CRUD MVC de usuarios y rutinas implementados con formularios, listados y vistas de detalle |
