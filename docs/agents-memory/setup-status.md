...
| Frontend | En progreso | CRUD MVC de usuarios, rutinas, pagos y asistencias implementados con formularios, listados y vistas de detalle, ademas de un layout administrativo coherente con sidebar y topbar |
